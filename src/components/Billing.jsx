...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
        <div className={layout.sectionImgReverse}>
            ...
            />
            <div className="absolute z-[3] w-[50%] h-[50%] -left-1 top-0 rounded-full white__gradient" />
            <div className="absolute z-[0] w-[50%] h-[50%] -left-1 bottom-0 rounded-full pink__gradient" />
        </div>
